        ...
        return (
          <div className={styles.editableOperations} >

            {
              ...
              index ==26 || index ==31 || index ==37 || index ==38 || index ==42 || index ==46 || index ==50 || index ==54|| index ==55|| index ==61? <span></span> :
              editable ?
                <span>
    ...
    return (
      <div className={styles.normal}>
        ...
        <div className={styles.entryBody} id="bodyTable">
          ...
          <Table size="small" pagination={false} bordered={true}  columns={columns} dataSource={dataSource} scroll={{ x: 4000, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
          </Spin>
        </div>
        ...
        <div className={styles.entryBody} id="bodyTable1" style={{display:'none'}}>
          ...
          <Spin spinning={this.state.loading} >
            <Table size="small" pagination={false} bordered={true}  columns={columns2} dataSource={dataSource1} scroll={{ x: 4500, y: 820 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC1 }/>
          </Spin>
        </div>
        ...
        <div className={styles.entryBody} >
          <p>活动水平数据</p>
            ...
            <Table  size="small" pagination={false} bordered={true}  columns={columns3} dataSource={dataSource2} scroll={{ x: 5500, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
            ...
            <div className={styles.entryBody} >
              ...
              <Table  size="small" pagination={false} bordered={true}  columns={columns11} dataSource={dataSource11} scroll={{ x: 4000, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
        ...
        <div className={styles.entryBody} >
          <p>活动水平数据</p>
            <Table  size="small" pagination={false} bordered={true}  columns={columns4} dataSource={dataSource3} scroll={{ x: 5500, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
        </div>

          <div className={styles.entryBody} >
            <p>平均低位热值</p>
              <Table  size="small" pagination={false} bordered={true}  columns={columns5} dataSource={dataSource4} scroll={{ x: 5500, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
          </div>

            <div className={styles.entryBody} >
              <p>排放因子</p>
              <Table size="small"  pagination={false} bordered={true}  columns={columns6} dataSource={dataSource5} scroll={{ x: 800, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
            </div>
        </Spin>
        </div>
        ...
        <div id="noCoTable1" style={{display:'none'}}>
          <Spin spinning={this.state.loading} >
            <div className={styles.entryBody} >
              <p>活动水平数据</p>
              <Table  size="small" pagination={false} bordered={true}  columns={columns7} dataSource={dataSource6} scroll={{ x: 2000, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
            </div>

            <div className={styles.entryBody} >
              <p>平均低位热值</p>
              <Table  size="small" pagination={false} bordered={true}  columns={columns8} dataSource={dataSource7} scroll={{ x: 2000, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
            </div>

            <div className={styles.entryBody} >
              <p>移动源CH4排放因子</p>
              <Table size="small" pagination={false} bordered={true}  columns={columns9} dataSource={dataSource8} scroll={{ x: 2000, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
            </div>


            <div className={styles.entryBody} >
              <p>移动源NO2排放因子</p>
              <Table size="small" pagination={false} bordered={true}  columns={columns10} dataSource={dataSource9} scroll={{ x: 2000, y: 620 }} rowClassName={(record, index) => index % 2  === 0 ? '' :styles.columnsC }/>
            </div>
          </Spin>
        </div>
