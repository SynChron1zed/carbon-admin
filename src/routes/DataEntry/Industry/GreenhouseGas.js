                ...
                <Spin spinning={this.state.loading}>
                    ...
                    <div className={styles.entryBody} id="bodyTable3">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns2}
                               dataSource={dataSource2} scroll={{x: 1500, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable4">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns3}
                               dataSource={dataSource3} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable5">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns4}
                               dataSource={dataSource4} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable6">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns5}
                               dataSource={dataSource5} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable7">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns6}
                               dataSource={dataSource6} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable8">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns7}
                               dataSource={dataSource7} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable9">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns8}
                               dataSource={dataSource8} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable10">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns9}
                               dataSource={dataSource9} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable11">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns10}
                               dataSource={dataSource10} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
                    ...
                    <div className={styles.entryBody} id="bodyTable12">
                        ...
                        <Table size="small" pagination={false} bordered={true} columns={columns11}
                               dataSource={dataSource11} scroll={{x: 1000, y: 1520}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
