            ...
            <div className={styles.normal}>
                ...
                <div className={styles.content3}>
                    ...
                    <div className={styles.selectGas}>
                        <div className={styles.targetChoose}>
                            ...
                            <ul>
                                <li id="li1" className={'a1' == this.state.years ? styles.li_focus : styles.eee}
                                    onClick={() => {
                                        this.selesctYears('a1')
                                    }}>能源活动
                                </li>
                                <li id="li2" className={'a2' == this.state.years ? styles.li_focus : styles.eee}
                                    onClick={() => {
                                        this.selesctYears('a2')
                                    }}>工业生产过程
                                </li>
                                <li id="li3" className={'a3' == this.state.years ? styles.li_focus : styles.eee}
                                    onClick={() => {
                                        this.selesctYears('a3')
                                    }}>农业活动
                                </li>
                                <li id="li4" className={'a4' == this.state.years ? styles.li_focus : styles.eee}
                                    onClick={() => {
                                        this.selesctYears('a4')
                                    }}>土地利用变化和林业
                                </li>
                                <li id="li4" className={'a5' == this.state.years ? styles.li_focus : styles.eee}
                                    onClick={() => {
                                        this.selesctYears('a5')
                                    }}>废弃物处理
                                </li>
                            </ul>
                        </div>
                ...
                <div className={styles.content3}>
                    ...
                    <div className={styles.selectGas}>
                        <div className={styles.targetChoose}>
                            <span className={styles.selectH1}>温室气体年度对比分析<span
                                className={styles.normalTitle}>年份选择(任选2个)：</span></span>
                    ...
                    <div className={styles.saleTrend4} id="saleTrend6">
                        <Table pagination={false} bordered={true} columns={columns} dataSource={dataSource}
                               scroll={{x: 400, y: 250}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>

                    </div>
                    <div className={styles.saleTrend5} id="saleTrend7">
                        <Table pagination={false} bordered={true} columns={columns1} dataSource={dataSource1}
                               scroll={{x: 400, y: 250}}
                               rowClassName={(record, index) => index % 2 === 0 ? '' : styles.columnsC }/>
