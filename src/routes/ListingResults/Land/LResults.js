        ...
        post('/report/landUseChangeAndForestry/list', {
            ...
            .then((res) => {
                ...
                if (res.code == 0) {
                    ...
                    _Data1.push(Alldata.C.arborForest.toFixed(2))//乔木林
                    _Data1.push(Alldata.C.economicForest.toFixed(2))//经济林
                    _Data1.push(Alldata.C.bambooForest.toFixed(2))//竹林
                    _Data1.push(Alldata.C.countrySpecialIrrigation.toFixed(2))//特种灌木林
                    _Data1.push(Alldata.C.scatteredWoodSurroundedByTreesSparseForest.toFixed(2))//疏林、散生木和四旁树
                    _Data1.push(Alldata.C.harvestingConsumption.toFixed(2))//采伐消耗
                    _Data1.push(Alldata.C.lossOfConsumption.toFixed(2))//枯损消耗

                    _Data1.push((Alldata.C.combustionEmission + Alldata.C.decompositionOfEmission).toFixed(2))

                    _Data1.push(Alldata.C.combustionEmission.toFixed(2))//燃烧排放
                    _Data1.push(Alldata.C.decompositionOfEmission.toFixed(2))//分解排放
                    ...
                    _Data2.push((Alldata.CO2.arborForest + Alldata.CO2.economicForest + Alldata.CO2.bambooForest + Alldata.CO2.countrySpecialIrrigation + Alldata.CO2.scatteredWoodSurroundedByTreesSparseForest + Alldata.CO2.harvestingConsumption + Alldata.CO2.lossOfConsumption).toFixed(2))

                    _Data2.push(Alldata.CO2.arborForest.toFixed(2))//乔木林
                    _Data2.push(Alldata.CO2.economicForest.toFixed(2))//经济林
                    _Data2.push(Alldata.CO2.bambooForest.toFixed(2))//竹林
                    _Data2.push(Alldata.CO2.countrySpecialIrrigation.toFixed(2))//特种灌木林
                    _Data2.push(Alldata.CO2.scatteredWoodSurroundedByTreesSparseForest.toFixed(2))//疏林、散生木和四旁树
                    _Data2.push(Alldata.CO2.harvestingConsumption.toFixed(2))//采伐消耗
                    _Data2.push(Alldata.CO2.lossOfConsumption.toFixed(2))//枯损消耗

                    _Data2.push((Alldata.CO2.combustionEmission + Alldata.CO2.decompositionOfEmission).toFixed(2))
                    _Data2.push(Alldata.CO2.combustionEmission.toFixed(2))//燃烧排放
                    _Data2.push(Alldata.CO2.decompositionOfEmission.toFixed(2))//分解排放
                    ...
                    + (Alldata.CO2.combustionEmission + Alldata.CO2.decompositionOfEmission)).toFixed(2))
                    ...
                    _Data3.push('-')
                    _Data3.push('-')
                    _Data3.push(Alldata.CH4.combustionEmission.toFixed(2))
                    _Data3.push(Alldata.CH4.combustionEmission.toFixed(2))
                    _Data3.push('-')
                    _Data3.push(Alldata.CH4.combustionEmission.toFixed(2))
                    ...
                    _Data4.push('-')
                    _Data4.push('-')
                    _Data4.push(Alldata.N2O.combustionEmission.toFixed(2))
                    _Data4.push(Alldata.N2O.combustionEmission.toFixed(2))
                    _Data4.push('-')
                    _Data4.push(Alldata.N2O.combustionEmission.toFixed(2))


                    _Data5.push((Alldata.CO2.arborForest + Alldata.CO2.economicForest + Alldata.CO2.bambooForest + Alldata.CO2.countrySpecialIrrigation + Alldata.CO2.scatteredWoodSurroundedByTreesSparseForest + Alldata.CO2.harvestingConsumption + Alldata.CO2.lossOfConsumption).toFixed(2))
                    _Data5.push(Alldata.CO2.arborForest.toFixed(2))
                    _Data5.push(Alldata.CO2.economicForest.toFixed(2))
                    _Data5.push(Alldata.CO2.bambooForest.toFixed(2))
                    _Data5.push(Alldata.CO2.countrySpecialIrrigation.toFixed(2))
                    _Data5.push(Alldata.CO2.scatteredWoodSurroundedByTreesSparseForest.toFixed(2))
                    _Data5.push(Alldata.CO2.harvestingConsumption.toFixed(2))
                    _Data5.push(Alldata.CO2.lossOfConsumption.toFixed(2))

                    _Data5.push(((Alldata.CO2.combustionEmission + (Alldata.CH4.combustionEmission * 21 / 10000) + (Alldata.N2O.combustionEmission * 310 / 10000)) + Alldata.CO2.decompositionOfEmission).toFixed(2))

                    _Data5.push((Alldata.CO2.combustionEmission + (Alldata.CH4.combustionEmission * 21 / 10000) + (Alldata.N2O.combustionEmission * 310 / 10000)).toFixed(2))
                    _Data5.push(Alldata.CO2.decompositionOfEmission.toFixed(2))
                    ...
                    _Data6.push(Gut2.toFixed(2))
                    _Data6.push(Gut3.toFixed(2))
                    _Data6.push(Gut4.toFixed(2))
                    _Data6.push(Gut5.toFixed(2))
                    _Data6.push(Gut6.toFixed(2))
                    _Data6.push(Gut7.toFixed(2))
                    _Data6.push(Gut8.toFixed(2))
                    _Data6.push(Gut9.toFixed(2))
                    _Data6.push(Gut10.toFixed(2))
                    _Data6.push(Gut11.toFixed(2))
